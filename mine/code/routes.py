...
def all_camp_details(camp_id,username):
    ...
    if camp==None:
        #return render_template('all_camp_details.html',flagged_camp=flagged_camp,camp=camp,username=username)
        return render_template('all_camp_details.html',username=username)
...
def other_camp_details(camp_id,username):
    ...
    if camp!=None:
        ...
        return render_template('other_camp_details.html',username=username)
...
def all_ad_details(ad_id,username):
    ...
    if ad!=None:
        ...
        return render_template('all_ad_details.html',username=username)
...
def other_ad_details(ad_id,username):
    ...
    if ad!=None:
        ...
        return render_template('other_ad_details.html',username=username)
...
def all_camp_details_admin(camp_id,username):
    ...
    if camp!=None:
        ...
        return render_template('all_camp_details_admin.html',username=username)
...
def all_ad_details_admin(ad_id,username):
    ...
    if ad!=None:
        ...
        return render_template('all_ad_details_admin.html', username=username)
